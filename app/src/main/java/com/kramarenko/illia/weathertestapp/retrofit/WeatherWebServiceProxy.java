package com.kramarenko.illia.weathertestapp.retrofit;
...
public interface WeatherWebServiceProxy {
     ...
     * service.
     */
    final String sWeather_Service_URL =
     ...
     * http://api.openweathermap.org/data/2.5/weather?units=metric&q=location
     */
    @GET("/weather")
    WeatherData getWeatherData(@Query("units=metric&q") String location);
